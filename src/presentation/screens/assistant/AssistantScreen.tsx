...
const buildToolAwarePrompt = (userText: string, telemetry: string) => [
  ...
  "- Valid tool names: toggle_flashlight, battery_status, read_calendar, current_location, fire_notification, create_task, read_tasks, create_event, mark_task_completed, daily_briefing, break_down_goal, set_timer, get_weather, telegram_updates. NEVER invent other names.",
  "",
  "Examples:",
  "User: Hi",
